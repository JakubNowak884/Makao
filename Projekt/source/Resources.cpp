...
void Resources::loadLanguage(std::string _language)
{
	...
	//ka¿dy # oznacza inny stan gry, wiêc jest zapisywany do innego wektora
	//poszczególne linie w pliku s¹ oddzielone œrednikiem
	...
	//sprawdzenie czy plik jêzykowy zawiera³ poprawn¹ liczbê stanów gry oddzielonych # oraz linii
